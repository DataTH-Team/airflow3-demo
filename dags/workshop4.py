...
mysql_output_path = "/opt/airflow/dags/data/transaction_data_merged.parquet"
conversion_rate_output_path = "/opt/airflow/dags/data/conversion_rate.parquet"
final_output_path = "/opt/airflow/dags/data/workshop4_output.parquet"
...
@dag(default_args=default_args, tags=["workshop"])
